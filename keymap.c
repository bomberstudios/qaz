...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT(
    ...
    L_NUM,   KC_BSPC,                        SPC_3,                         L_SYM,   L_SYM
  ),
  [_QWERTY] = LAYOUT(
  ...
  [_MOVE] = LAYOUT(
    ...
    UNDO,    CUT,     COPY,    CPYPASTE,SKRUN,   SKRUNAG, SHT_SCR, SHT_ARE, SHT_OPT,
    KC_ESC,  _______,                      _______,                         _______, KC_PENT
  ),
  [_NUMBER] = LAYOUT(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, KC_7,    KC_8,    KC_9,    _______,
    CMD_1,   CMD_2,   CMD_3,   CMD_4,   CMD_5,   _______, KC_4,    KC_5,    KC_6,    KC_0,
    KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, KC_1,    KC_2,    KC_3,
  ...
  [_SYMBOL] = LAYOUT(
    ...
    RESET,   _______, KC_TILD, KC_DQUO, KC_SCLN, KC_PIPE, KC_UNDS, KC_PLUS, KC_LCBR,
                               L_ADJ,   KC_DEL,  _______, _______, _______
  ),
   [_ADJUST] = LAYOUT(
